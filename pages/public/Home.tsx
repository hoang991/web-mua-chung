...
const Home = () => {
  ...
  const renderSection = (section: SectionContent) => {
      ...
      switch (section.type) {
          case 'hero':
              return (
                <Section key={section.id} className="relative overflow-hidden bg-stone-50 py-16 md:py-20 lg:py-32">
                    ...
                    <Container className="relative z-10 px-4">
                        ...
                        <FadeIn delay={400}>
                            ...
                            <Link to={section.ctaLink || '/model'}>
                                <Button size="lg" className="w-full sm:w-auto gap-2 py-3.5 md:py-3">
                                {section.ctaText || 'Tìm hiểu ngay'} <ArrowRight className="w-4 h-4" />
                                </Button>
                            </Link>
          ...
          case 'features': // Pillars
              return (
                <Section key={section.id} className="bg-white">
                    <Container>
                        <div className="text-center mb-10 md:mb-16">
                        <h2 className="text-2xl md:text-3xl font-bold text-stone-900 mb-4">{section.title}</h2>
                        <p className="text-stone-600 px-4">{section.subtitle}</p>
                        </div>
          ...
          case 'products': // Vườn giải pháp
              return (
                <Section key={section.id} className="bg-stone-50">
                    <Container>
                        <div className="text-center mb-10">
                            <h2 className="text-2xl md:text-3xl font-bold text-stone-900 mb-4 font-serif">{section.title}</h2>
          ...
          case 'events':
              ...
              return (
                <Section key={section.id} className="bg-amber-50 relative overflow-hidden">
                    ...
                    <Container className="relative z-10">
                        <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-4">
                            <div className="text-center md:text-left">
                                <h2 className="text-2xl md:text-3xl font-bold text-stone-900 mb-2">{section.title}</h2>
                    ...
                    <Container>
                        ...
                        <FadeIn>
                            ...
                            <div className="aspect-[4/3] bg-stone-200 rounded-2xl overflow-hidden shadow-lg">
                                <img 
                                    src={section.image || "https://picsum.photos/800/600?grayscale"} 
                                    alt="Community" 
                        ...
                        <div className="space-y-6 md:space-y-8">
                            <div>
                            <h2 className="text-2xl md:text-3xl font-bold text-stone-900 mb-4 md:mb-6">{section.title}</h2>
                            {section.subtitle && <p className={`${primaryText} font-medium mb-4`}>{section.subtitle}</p>}
  ...
  // Create a copy to sort, avoiding mutation of state directly
